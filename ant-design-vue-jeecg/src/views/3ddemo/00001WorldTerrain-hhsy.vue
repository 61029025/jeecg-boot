...
export default {
  ...
  mounted() {
    ...
    viewer.entities.add({
      position: Cesium.Cartesian3.fromDegrees(117.19632254805451, 39.125371612761384),
      label: {
        text: "恒华数元",
    ...
    viewer.camera.flyTo({
      destination: Cesium.Cartesian3.fromDegrees(117.19632254805451, 39.110371612761384, 500),
      orientation: {
